...
function getBatchesFields(): INodeProperties[] {
	...
	getFields[0].options?.push(
		...
		},
		{
			...
			type: 'boolean',
			default: false,
			description: 'Include cost fields in response',
		},
	);
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					type: 'string',
					default: '',
					description: 'Billing location ID',
				},
			],
		},
		{
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					type: 'number',
					default: 0,
					description: 'Dutchie product ID',
				},
				{
					...
					type: 'string',
					default: '',
					description: 'Dutchie retailer ID',
				},
				{
